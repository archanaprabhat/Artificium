...
function Center() {
  return (
    <div className='w-full flex-1 flex flex-col justify-center items-center gap-4 h-fit '>
      <div className='py-5 h-full mb-[200px] w-full flex flex-col gap-10 overflow-y-auto'>
      ...
      <div className='w-full h-20 p-6 bg-neutral-950 rounded-2xl justify-start items-center gap-16 inline-flex  mt-7 absolute left-0 right-0 bottom-0'>
        ...
        <div className='grow shrink basis-0 h-12 py-3 justify-start items-start gap-2 flex'>
          <input
            className='text-white  font-semibold w-full leading-normal tracking-tight bg-neutral-950 border-none focus:ring-0 focus:border-none focus:border-transparent focus:outline-none placeholder-text-neutral-700 animate-typing overflow-hidden'
